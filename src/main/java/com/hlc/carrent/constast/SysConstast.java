package com.hlc.carrent.constast;
...
public interface SysConstast {
     ...
     * 登录判断
     */
    String USER_LOGIN_ERROR_MSG = "用户名或者密码不正确";
    String USER_LOGIN_CODE_ERROR_MSG = "验证码不正确";
    String USER_LOGIN_CODE_ERROR_NULL = "请输入验证码";
    /**
     * 可用状态
     */
    ...
    String RENT_OUT_SUCCESS = "出租成功";
    String RENT_OUT_ERROR = "出租失败";
    /**
     * 公用常量
     */
    Integer CODE_ZERO = 0;

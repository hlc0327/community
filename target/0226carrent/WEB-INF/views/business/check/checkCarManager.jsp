    ...
    <blockquote class="layui-elem-quote" style="margin-top: 10px;">
        ...
        <form class="layui-form" method="post" id="checkFrm" lay-filter="checkFrm">
            ...
            <div class="layui-form-item" style="text-align: center;">
                <button type="button"  lay-submit="" lay-filter="doSubmit_save"
...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'laydate'],
        function () {
            ...
            form.on("submit(doSubmit_save)",function () {
                var param = $("#checkFrm").serialize();
                //发送保存请求
                $.post("${pageContext.request.contextPath}/check/saveCheck",param,function (obj) {
                    layer.msg(obj.msg);
                    $("#content").hide();
                });
                return false;

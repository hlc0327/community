...
<form class="layui-form" method="post" id="searchFrm">
    <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-inline" style="margin:5px 0 0 500px">
...
<div id="newsBar" style="display: none;">
    ...
    <a class="layui-btn layui-btn-warm layui-btn-xs" lay-event="viewNews">查看公告更多内容</a>
</div>
<!-- 数据表格结束 -->
    ...
    <form class="layui-form" lay-filter="dataFrm" id="dataFrm">
        ...
        <div class="layui-form-item" style="text-align: center;">
            <div class="layui-input-block">
                ...
                <button type="reset" id="emptyDataContent" class="layui-btn layui-btn-warm layui-btn-sm layui-icon layui-icon-refresh" >重置</button>
            </div>
        </div>
    </form>
...
<div id="viewNewDiv" style="padding:10px;display: none;">
    ...
    <div id="view_content" style="margin-left: 20px"></div>
</div>
...
<script type="text/javascript">
    ...
    layui.extend({
    ...
    }).use(['jquery', 'layer', 'form', 'table', 'laydate','layedit'], function () {
        var $ = layui.jquery;
        ...
        tableIns = table.render({
            ...
            , cols: [[   //列表数据
                ...
                , {fixed: 'right', title: '操作', toolbar: '#newsBar', width: 250, align: 'center',}
            ]]
        });
        //模糊查询
        ...
        table.on('tool(newsTable)', function (obj) {
            ...
            if (layEvent === 'del') { //删除
                ...
                layer.confirm('真的删除行 [ ' + data.title + ' ] 这个公告吗?', function (index) {
                    layer.close(index);
                    //向服务端发送删除指令
        ...
        //监听重置按钮,重置后把内容设置为空
        $("#emptyDataContent").click(function(){
        ...
        function deleteBatch() {
            ...
            if (dataLength > 0) {
                ...
                //发送请求
                layer.confirm('真的删除选中的 [ ' + ids + ' ] 这些公告吗', function (index) {
                    //向服务端发送删除指令

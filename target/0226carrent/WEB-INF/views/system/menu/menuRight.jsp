    ...
    <form class="layui-form" lay-filter="dataFrm" id="dataFrm">
            ...
            <div class="layui-input-block">
                <div class="layui-unselect layui-form-select" id="pid_div">
                    <div class="layui-select-title">
                        ...
                        <input type="text" id="pid_str" placeholder="请选择" readonly=""
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="target" value="" placeholder="请输入TRAGET" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="radio" name="spread2" value="1" title="展开">
                    <input type="radio" name="spread2" value="0" title="不展开" checked="checked">
                </div>
            </div>
            <div class="layui-inline">
            ...
            if (layEvent === 'del') { //删除
                ...
                $.post("${pageContext.request.contextPath}/menu/checkMenuHasChildren?id=" + data.id, function (obj) {
                    if (obj.code >= 0) {
                        ...
                        layer.confirm('真的删除行 [ ' + data.title + ' ] 这个菜单吗?', function (index) {
                            layer.close(index);
                            //向服务端发送删除指令
        ...
        function openUpdateMenu(data) {
            mainIndex = layer.open({
                ...
                success: function (index) {
                    ...
                    //反选下拉树
                    var params = dtree.dataInit("menuTree", data.pid);
                    //移除打开的样式
                    $("#menuSelectDiv").removeClass("layui-show");
                    //给下拉框的text赋值
